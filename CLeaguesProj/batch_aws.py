...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "CLeaguesProj.settings_aws_prod")
...
def main():
    print("Starting Job - Ranking Calculation and Notifications")
    ...
    print("Finishing Job - Ranking Calculation and Notifications")
